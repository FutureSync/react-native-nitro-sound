...
open class HybridSoundSpec_cxx {
  ...
  @inline(__always)
  public final func addPcmChunkListener(callback: bridge.Func_void_std__shared_ptr_ArrayBuffer_) -> bridge.Result_void_ {
    do {
      try self.__implementation.addPcmChunkListener(callback: { () -> (ArrayBuffer) -> Void in
  ...
  @inline(__always)
  public final func removePcmChunkListener() -> bridge.Result_void_ {
    do {
      try self.__implementation.removePcmChunkListener()
      return bridge.create_Result_void_()
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_void_(__exceptionPtr)
  ...
  @inline(__always)
  public final func startMockPcmStream(wavFilePath: std.string, sampleRateHz: bridge.std__optional_double_) -> bridge.Result_void_ {
    do {
      try self.__implementation.startMockPcmStream(wavFilePath: String(wavFilePath), sampleRateHz: sampleRateHz.value)
      return bridge.create_Result_void_()
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_void_(__exceptionPtr)
  ...
  @inline(__always)
  public final func stopMockPcmStream() -> bridge.Result_void_ {
    do {
      try self.__implementation.stopMockPcmStream()
      return bridge.create_Result_void_()
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_void_(__exceptionPtr)
  ...
  @inline(__always)
  public final func restorePendingRecordings(directory: bridge.std__optional_std__string_) -> bridge.Result_std__shared_ptr_Promise_std__vector_RestoredRecording____ {
    do {
      let __result = try self.__implementation.restorePendingRecordings(directory: { () -> String? in
        if bridge.has_value_std__optional_std__string_(directory) {
          let __unwrapped = bridge.get_std__optional_std__string_(directory)
          return String(__unwrapped)
        } else {
          return nil
        }
      }())
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_std__vector_RestoredRecording___ in
        let __promise = bridge.create_std__shared_ptr_Promise_std__vector_RestoredRecording___()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_std__vector_RestoredRecording___(__promise)
        __result
          .then({ __result in __promiseHolder.resolve({ () -> bridge.std__vector_RestoredRecording_ in
              var __vector = bridge.create_std__vector_RestoredRecording_(__result.count)
      ...
      return bridge.create_Result_std__shared_ptr_Promise_std__vector_RestoredRecording____(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_std__shared_ptr_Promise_std__vector_RestoredRecording____(__exceptionPtr)
    }
  }
  
  @inline(__always)
  public final func restoreRecording(wavFilePath: std.string) -> bridge.Result_std__shared_ptr_Promise_RestoredRecording___ {
    do {
      let __result = try self.__implementation.restoreRecording(wavFilePath: String(wavFilePath))
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_RestoredRecording__ in
        let __promise = bridge.create_std__shared_ptr_Promise_RestoredRecording__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_RestoredRecording__(__promise)
        __result
          .then({ __result in __promiseHolder.resolve(__result) })
          .catch({ __error in __promiseHolder.reject(__error.toCpp()) })
        return __promise
      }()
      return bridge.create_Result_std__shared_ptr_Promise_RestoredRecording___(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_std__shared_ptr_Promise_RestoredRecording___(__exceptionPtr)
    }
  }
  
  @inline(__always)
  public final func mergeAudioFiles(filePaths: bridge.std__vector_std__string_, outputPath: bridge.std__optional_std__string_) -> bridge.Result_std__shared_ptr_Promise_MergeResult___ {
    do {
      let __result = try self.__implementation.mergeAudioFiles(filePaths: filePaths.map({ __item in String(__item) }), outputPath: { () -> String? in
        if bridge.has_value_std__optional_std__string_(outputPath) {
          let __unwrapped = bridge.get_std__optional_std__string_(outputPath)
          return String(__unwrapped)
        } else {
          return nil
        }
      }())
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_MergeResult__ in
        let __promise = bridge.create_std__shared_ptr_Promise_MergeResult__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_MergeResult__(__promise)
        __result
          .then({ __result in __promiseHolder.resolve(__result) })
          .catch({ __error in __promiseHolder.reject(__error.toCpp()) })
        return __promise
      }()
      return bridge.create_Result_std__shared_ptr_Promise_MergeResult___(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_std__shared_ptr_Promise_MergeResult___(__exceptionPtr)
    }
  }
  
  @inline(__always)
  public final func getAudioDuration(filePath: std.string) -> bridge.Result_std__shared_ptr_Promise_double___ {
    do {
      let __result = try self.__implementation.getAudioDuration(filePath: String(filePath))
  ...
  @inline(__always)
  public final func validateAudio(filePath: std.string, minDurationSecs: bridge.std__optional_double_) -> bridge.Result_std__shared_ptr_Promise_AudioValidationResult___ {
    do {
      let __result = try self.__implementation.validateAudio(filePath: String(filePath), minDurationSecs: minDurationSecs.value)
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_AudioValidationResult__ in
        let __promise = bridge.create_std__shared_ptr_Promise_AudioValidationResult__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_AudioValidationResult__(__promise)
        __result
          .then({ __result in __promiseHolder.resolve(__result) })
          .catch({ __error in __promiseHolder.reject(__error.toCpp()) })
        return __promise
      }()
      return bridge.create_Result_std__shared_ptr_Promise_AudioValidationResult___(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_std__shared_ptr_Promise_AudioValidationResult___(__exceptionPtr)
    }
  }
  
  @inline(__always)
  public final func resetRecordingState() -> bridge.Result_std__shared_ptr_Promise_std__string___ {
    do {
      let __result = try self.__implementation.resetRecordingState()
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_std__string__ in
        let __promise = bridge.create_std__shared_ptr_Promise_std__string__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_std__string__(__promise)
        __result
