...
namespace margelo::nitro::sound {
  ...
  public:
    ...
    inline std::shared_ptr<Promise<std::vector<RestoredRecording>>> restorePendingRecordings(const std::optional<std::string>& directory) override {
      auto __result = _swiftPart.restorePendingRecordings(directory);
      if (__result.hasError()) [[unlikely]] {
        std::rethrow_exception(__result.error());
      }
      auto __value = std::move(__result.value());
    ...
    inline std::shared_ptr<Promise<RestoredRecording>> restoreRecording(const std::string& wavFilePath) override {
      auto __result = _swiftPart.restoreRecording(wavFilePath);
      if (__result.hasError()) [[unlikely]] {
        std::rethrow_exception(__result.error());
      }
      auto __value = std::move(__result.value());
    ...
    inline std::shared_ptr<Promise<MergeResult>> mergeAudioFiles(const std::vector<std::string>& filePaths, const std::optional<std::string>& outputPath) override {
      auto __result = _swiftPart.mergeAudioFiles(filePaths, outputPath);
      if (__result.hasError()) [[unlikely]] {
        std::rethrow_exception(__result.error());
      }
      auto __value = std::move(__result.value());
    ...
    inline std::shared_ptr<Promise<double>> getAudioDuration(const std::string& filePath) override {
      auto __result = _swiftPart.getAudioDuration(filePath);
      if (__result.hasError()) [[unlikely]] {
        std::rethrow_exception(__result.error());
      }
      auto __value = std::move(__result.value());
    ...
    inline std::shared_ptr<Promise<AudioValidationResult>> validateAudio(const std::string& filePath, std::optional<double> minDurationSecs) override {
      auto __result = _swiftPart.validateAudio(filePath, minDurationSecs);
      if (__result.hasError()) [[unlikely]] {
        std::rethrow_exception(__result.error());
      }
      auto __value = std::move(__result.value());
