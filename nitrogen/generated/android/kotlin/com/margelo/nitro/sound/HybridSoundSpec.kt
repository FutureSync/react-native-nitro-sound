...
abstract class HybridSoundSpec: HybridObject() {
  ...
  @DoNotStrip
  @Keep
  abstract fun restorePendingRecordings(directory: String?): Promise<Array<RestoredRecording>>
  
  @DoNotStrip
  @Keep
  abstract fun restoreRecording(wavFilePath: String): Promise<RestoredRecording>
  
  @DoNotStrip
  @Keep
  abstract fun mergeAudioFiles(filePaths: Array<String>, outputPath: String?): Promise<MergeResult>
  
  @DoNotStrip
  @Keep
  abstract fun getAudioDuration(filePath: String): Promise<Double>
