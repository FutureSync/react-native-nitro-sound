...
#include <vector>
#include "JRestoredRecording.hpp"
#include "MergeResult.hpp"
#include "JMergeResult.hpp"
#include "AudioValidationResult.hpp"
#include "JAudioValidationResult.hpp"
#include <optional>
...
namespace margelo::nitro::sound {
  ...
  std::shared_ptr<Promise<std::vector<RestoredRecording>>> JHybridSoundSpec::restorePendingRecordings(const std::optional<std::string>& directory) {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<jni::JString> /* directory */)>("restorePendingRecordings");
    auto __result = method(_javaPart, directory.has_value() ? jni::make_jstring(directory.value()) : nullptr);
    return [&]() {
      auto __promise = Promise<std::vector<RestoredRecording>>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& __boxedResult) {
        auto __result = jni::static_ref_cast<jni::JArrayClass<JRestoredRecording>>(__boxedResult);
        __promise->resolve([&]() {
          size_t __size = __result->size();
          std::vector<RestoredRecording> __vector;
  ...
  std::shared_ptr<Promise<RestoredRecording>> JHybridSoundSpec::restoreRecording(const std::string& wavFilePath) {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<jni::JString> /* wavFilePath */)>("restoreRecording");
    auto __result = method(_javaPart, jni::make_jstring(wavFilePath));
    return [&]() {
      auto __promise = Promise<RestoredRecording>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& __boxedResult) {
        auto __result = jni::static_ref_cast<JRestoredRecording>(__boxedResult);
  ...
  std::shared_ptr<Promise<MergeResult>> JHybridSoundSpec::mergeAudioFiles(const std::vector<std::string>& filePaths, const std::optional<std::string>& outputPath) {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<jni::JArrayClass<jni::JString>> /* filePaths */, jni::alias_ref<jni::JString> /* outputPath */)>("mergeAudioFiles");
    auto __result = method(_javaPart, [&]() {
      size_t __size = filePaths.size();
      jni::local_ref<jni::JArrayClass<jni::JString>> __array = jni::JArrayClass<jni::JString>::newArray(__size);
      for (size_t __i = 0; __i < __size; __i++) {
        const auto& __element = filePaths[__i];
        auto __elementJni = jni::make_jstring(__element);
        __array->setElement(__i, *__elementJni);
      }
      return __array;
    }(), outputPath.has_value() ? jni::make_jstring(outputPath.value()) : nullptr);
    return [&]() {
      auto __promise = Promise<MergeResult>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& __boxedResult) {
        auto __result = jni::static_ref_cast<JMergeResult>(__boxedResult);
        __promise->resolve(__result->toCpp());
      });
      __result->cthis()->addOnRejectedListener([=](const jni::alias_ref<jni::JThrowable>& __throwable) {
        jni::JniException __jniError(__throwable);
  ...
  std::shared_ptr<Promise<double>> JHybridSoundSpec::getAudioDuration(const std::string& filePath) {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<jni::JString> /* filePath */)>("getAudioDuration");
  ...
  std::shared_ptr<Promise<AudioValidationResult>> JHybridSoundSpec::validateAudio(const std::string& filePath, std::optional<double> minDurationSecs) {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<jni::JString> /* filePath */, jni::alias_ref<jni::JDouble> /* minDurationSecs */)>("validateAudio");
    auto __result = method(_javaPart, jni::make_jstring(filePath), minDurationSecs.has_value() ? jni::JDouble::valueOf(minDurationSecs.value()) : nullptr);
    return [&]() {
      auto __promise = Promise<AudioValidationResult>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& __boxedResult) {
        auto __result = jni::static_ref_cast<JAudioValidationResult>(__boxedResult);
        __promise->resolve(__result->toCpp());
      });
      __result->cthis()->addOnRejectedListener([=](const jni::alias_ref<jni::JThrowable>& __throwable) {
        jni::JniException __jniError(__throwable);
  ...
  std::shared_ptr<Promise<std::string>> JHybridSoundSpec::resetRecordingState() {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>()>("resetRecordingState");
    auto __result = method(_javaPart);
    return [&]() {
      auto __promise = Promise<std::string>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& __boxedResult) {
